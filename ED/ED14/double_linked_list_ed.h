...
//
//  Implementaci�n del TAD double_linked_list con nodos doblemente
...
//  Adaptada de la implementaci�n del deque realizada por Alberto Verdejo
...
public:
    ...
    // consultar el �ltimo elemento de la lista
    T const& back() const {
        if (empty())
    ...
    // consultar si la lista est� vac�a
    bool empty() const {
